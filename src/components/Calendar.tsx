...
const dayEventVariants = cva('font-bold border-l-4 rounded p-2 text-xs', {
  variants: {
    variant: {
      black: 'bg-black text-black border-black',
...
const CalendarMonthView = () => {
  ...
  return (
    <div className="h-full min-h-[27rem] mb-2 flex flex-col flex-1">
      <div className="grid grid-cols-7 gap-px sticky top-0 bg-background border-b mr-5">
        {weekDays.map((day, i) => (
          <div
            key={day}
            className={cn(
